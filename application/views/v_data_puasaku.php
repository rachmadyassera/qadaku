...
<head>
  ...
  <title>Dashboard Qada Puasaku &mdash; SiQada</title>
      ...
      <div class="main-content">
          ...
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1 shadow">
                ...
                <div class="card-wrap">
                  <div class="card-header">
                    <h4>Total Qada Puasa telah dilaksanakan</h4>
                  </div>
                  <div class="card-body">
                  <?=$total_qps;?>&nbsp;Hari
                  </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12">
              <div class="card card-statistic-1 shadow">
                ...
                <div class="card-wrap">
                  <div class="card-header">
                    <h4>Jumlah Hutang Qada Puasaku </h4>
                  </div>
                  <div class="card-body">

                <?php if ($total_tqp-$total_qps == '0'): ?>
                            
                    <div class = "badge badge-info">
                        <?php  echo 'Qada Puasa Selesai'; ?>
                    </div>
                        <?php else: ?>
                    <?=$total_tqp-$total_qps;?>&nbsp;Hari
                <?php endif; ?>
            ...
            <div class="col-lg-4 col-md-12 col-12 col-sm-12">
              <div class="card shadow">
                <div class="card-header">
                <h4>Aktifitas Puasaku</h4>
                <?php if ($total_tqp-$total_qps == '0'): ?>

                <?php else: ?>
                    <a href="<?php echo base_url().'puasaku/add_qps'?>" class="btn btn-sm btn-primary"><i class="fas fa-user-plus"> </i> Puasa Hari ini </a>
                <?php endif; ?>
                  
                </div>
                <div class="card-body">             
                  <ul class="list-unstyled list-unstyled-border">
                  <?php foreach($qps->result() as $qps): ?>
                    <li class="media">
                      <div class="media-body">
                        <div class="float-right text-primary">+<?php echo $qps->qps_jumlah; ?> Hari</div>
                        <div class="media-title">
                            <div class = "badge badge-info">
                                <?php
                                foreach ($get_all_user->result() as $gau): 
                                ?>
                                <?php if ($qps->id_user_qps == $gau->id_user): ?>
                        ...
                        <span class="text-small text-muted">Ditambahkan pada : <?php echo $qps->create_at; ?></span>
                        <a href="<?php echo base_url().'puasaku/hapus/'?><?php echo $qps->id_qada_puasa_selesai;?>" class="btn btn-sm btn-danger">Hapus</a>
                      </div>
                    </li>
        ...
        <div class="row">
              <div class="col-12">
                <div class="card shadow">
                  <div class="card-header">
                    <h4>Tabel Data Target Qada Puasaku</h4>
                    
                    <a href="<?php echo base_url().'puasaku/add_tqp'?>" class="btn btn-sm btn-warning"><i class="fas fa-plus-circle"></i> Jumlah Qadaku</a>
                  </div>
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <?php 
                            $no = 0;
                            foreach ($tqp->result() as $tqp): 
                            $no++;
                        ?>
                        
                        <tr>
                            <td style="vertical-align: middle;"><?php echo $no;?></td>
                            <td style="vertical-align: middle;"><?php echo $tqp->tqp_keterangan;?></td>
                            <td style="vertical-align: middle;"><?php echo $tqp->tqp_tahun;?></td>
                            <td style="vertical-align: middle;"><?php echo $tqp->tqp_jumlah;?> Hari</td>
                            <td style="vertical-align: middle;"><?php echo $tqp->create_at;?></td>
                            ...
                            <div class="dropdown d-inline mr-2">
                              ...
                              <div class="dropdown-menu" > 
                                <a class="dropdown-item has-icon" id="toastr-3" href="<?php echo site_url('puasaku/hapustqp/'.$tqp->id_target_qada_puasa);?>"><i class="fas fa-trash"></i> Hapus</a>
                              </div>
                            </div>
                            </td>
                        </tr>
...
<?php if($this->session->flashdata('msg')=='error'):?>
        ...
        <?php elseif($this->session->flashdata('msg')=='success'):?>
            <script type="text/javascript">
                    $.toast({
                        heading: 'Success',
                        text: "Alhamdulillah, Data Puasa Berhasil disimpan !",
                        showHideTransition: 'slide',
                        icon: 'success',
                        hideAfter: false,
                        position: 'bottom-right',
        ...
        <?php elseif($this->session->flashdata('msg')=='success-target'):?>
            <script type="text/javascript">
                    $.toast({
                        heading: 'Success',
                        text: "Data Target Qada Puasa Berhasil disimpan !.",
                        showHideTransition: 'slide',
                        icon: 'success',
                        hideAfter: false,
                        position: 'bottom-right',
        ...
        <?php elseif($this->session->flashdata('msg')=='error-add'):?>
            <script type="text/javascript">
                    $.toast({
                        heading: 'Oops..',
                        text: "Tidak dapat menambahkan Qada Puasa, karena jumlah Target Qada Puasa telah dicapai/diselesaikan",
                        showHideTransition: 'slide',
                        icon: 'success',
                        hideAfter: false,
                        position: 'bottom-right',
