  ...
  <div   class = "navbar-bg"></div>
      ...
      <div     class = "section-header">
          ...
          <div class = "section-body">
            <div  class  = "row">
            <form style="width:100%" action = "<?php echo base_url().'users/update'?>" method = "post" enctype = "multipart/form-data">
            <div  class  = "col-12">
            <div  class  = "card">
            <div  class  = "card-header">
                  ...
                  <input type="text" value="<?php echo $dtl_usr['user_name'];?>" name="name" class="form-control" placeholder="Name" required>
                      </div>
                    </div>
                    <div   class = "form-group row mb-4">
                    <label class = "col-form-label text-md-right col-12 col-md-3 col-lg-3">Email</label>
                    <div   class = "col-sm-12 col-md-7">
                    <input type="email" value="<?php echo $dtl_usr['user_email'];?>" name="email" class="form-control" placeholder="Email" required>
                      </div>
                    </div>
                    <div   class = "form-group row mb-4">
                    <label class = "col-form-label text-md-right col-12 col-md-3 col-lg-3">Password</label>
                    <div   class = "col-sm-12 col-md-7">
                    <input type="password"  id="inputpass1" name="password" class="form-control" placeholder="Password" >
                      </div>
                    </div>
                    <div   class = "form-group row mb-4">
                    <label class = "col-form-label text-md-right col-12 col-md-3 col-lg-3">Confirm Password </label>
                    <div   class = "col-sm-12 col-md-7">
                    <input type="password" id="inputpass2" onkeyup="cekPass()" name="password2" class="form-control" placeholder="Confirm Password" >
                      </div>
                      <p id="notifpass"></p>
                    </div> 
                    <div    class = "form-group row mb-4">
                    ...
                    <select class="form-control" name="level" required>
                        <?php if($dtl_usr['user_level']=='0'):?>
                        <option value="0" selected>Super Admin</option>
                        <option value="1">Admin</option>
                        <option value="2">User</option>
                        <?php elseif($dtl_usr['user_level']=='1'):?>
                        ...
                        <option value="0" >Super Admin</option>
                        <option value="1" >Admin</option>
                        <option value="2" selected><?php?>User</option>
                        <?php endif;?>
                        </select>
                      </div>
                    </div>
                    ...
                    <div   class = "col-sm-12 col-md-7">
                    <input type="file" name="pp" class="dropify" data-height="220" data-default-file="<?php echo base_url().'assets/image-user/'.$dtl_usr['user_photo'];?>">
                      </div>
                    </div>
                    <div    class = "form-group row mb-4">
                    ...
                    <input  type  = "hidden" name = "user_id" value = "<?php echo $dtl_usr['user_id'];?>" required>
                    <div    class = "col-sm-12 col-md-7"><center>
                    <button class = "btn btn-success" id="swal-2">Save Changes</button>
                    </center></div>
                    </div>
                  </div>
                </div>
