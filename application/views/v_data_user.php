...
<head>
  ...
  <title>Users &rsaquo; DataTables &mdash; Sipentatim</title>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-button">
              <a href="<?php echo base_url().'users/add_new'?>" class="btn btn-primary">Add New</a>
            </div>
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;" >
                                ...
                                <?php else:?>
                                <img class="rounded-circle profile-widget-picture" width="50" src="<?php echo base_url().'assets/image-user/'.$row->user_photo;?>">
                                <?php endif;?>
                            </td>
                            <td style="vertical-align: middle;"><?php echo $row->user_name;?></td>
                            <td style="vertical-align: middle;"><?php echo $row->user_email;?></td>
                            <td style="vertical-align: middle;"><div class="badge badge-info">
                                <?php 
                                    if($row->user_level=='0'){
                                        echo "Super Admin";
                            ...
                            <?php if($row->user_status=='1'):?>
                              <td style="vertical-align: middle;"><div class="badge badge-success">Aktif</div></td>
                            <?php else:?>
                              <td style="vertical-align: middle;"><div class="badge badge-danger">Disable</div></td>
                            <?php endif;?>
                            <td style="vertical-align: middle;">
                            <div class="dropdown d-inline mr-2">
                              ...
                              <div class="dropdown-menu" > 
                                <a class="dropdown-item has-icon" href="<?php echo site_url('users/detail/'.$row->user_id);?>"><i class="fas fa-info-circle"></i> Detail</a>
                                <a class="dropdown-item has-icon" id="toastr-3" href="<?php echo site_url('users/delete/'.$row->user_id);?>"><i class="fas fa-trash"></i> Delete</a>
                              </div>
                            </div>
                            </td>
                        </tr>
