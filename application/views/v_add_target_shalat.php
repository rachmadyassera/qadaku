...
<head>
  ...
  <title>Halaman &rsaquo; Input Baru &mdash; Target Qada Shalat</title>
...
<body>
  ...
  <div   class = "navbar-bg"></div>
      ...
      <div     class = "section-header">
            <h1>Input Baru Target Qada Shalatku</h1>
          ...
          <div class="section-body">
            <h2 class="section-title">Form Data Isian Target Shalatku</h2>

            <form style="width:100%" action = "<?php echo base_url().'shalatku/create_tqs'?>" method = "post" enctype = "multipart/form-data">
            <div class="row">
              <div class="col-12">
                <div class="card shadow">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="keterangan" class="form-control" placeholder="Keterangan Qada Shalat yang ingin dicapai, Contoh : Qada Shalat Tahun 2014 Karena Sakit" required>
                    </div>

                    <div class="form-group">
                      <label>Pilih Waktu Shalat yang di Qada</label>
