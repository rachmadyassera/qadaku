...
<head>
  ...
  <title>Halaman &rsaquo; Input Baru &mdash; Target Qada Puasa</title>
...
<body>
  ...
  <div   class = "navbar-bg"></div>
      ...
      <div     class = "section-header">
            <h1>Input Baru Target Qada Puasaku</h1>
            <div class = "section-header-breadcrumb">
            <div class = "breadcrumb-item active"><a href = "#">Dashboard</a></div>
            <div class = "breadcrumb-item"><a href        = "#">Puasaku</a></div>
            <div class = "breadcrumb-item">Input Baru</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Form Data Isian Target Puasaku</h2>

            <form style="width:100%" action = "<?php echo base_url().'puasaku/create_tqp'?>" method = "post" enctype = "multipart/form-data">
            <div class="row">
              <div class="col-12">
                <div class="card shadow">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="keterangan" class="form-control" placeholder="Keterangan Qada Puasa yang ingin dicapai" required>
                    </div>

                    <div class="form-group">
                      <label>Tahun Qada Puasa  </label>
                      <input type="text" name="tahun" class="form-control" placeholder="Contoh : 2014" required>
                    </div>

                    <div class="form-group">
                      <label>Jumlah Qada Puasa (Hari) </label>
