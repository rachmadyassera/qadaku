...
<head>
  ...
  <title>Forms &rsaquo; Add New &mdash; Pengumuman</title>
  ...
  <div   class = "navbar-bg"></div>
      ...
      <div     class = "section-header">
          ...
          <div class="section-body">
            ...
            <form style="width:100%" action = "<?php echo base_url().'pengumuman/insert'?>" method = "post" enctype = "multipart/form-data">
            <div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      <label>Judul  </label>
                      <input type="text" name="judul" class="form-control" placeholder="Topik atau Tajuk Pengumuman" required>
                    </div>

                    <div class="form-group">
                      <label>Deskripsi </label>
                      <textarea style="height:100px;" class="form-control" name="deskripsi" placeholder="Keterangan Pengumuman" required></textarea>
                    </div>

                    <div   class = "form-group">
                    <label class = "col-form-label">Info Grafis</label>
                    <input type="file" name="gbr" class="dropify" data-height="520">
                    </div>
